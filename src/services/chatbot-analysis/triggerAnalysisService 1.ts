...
const FALLBACK_MODEL = "arcee-ai/trinity-large-preview:free"; // Smaller, faster fallback
...
Respond ONLY with valid JSON in this exact format:
{
  ...
  "privacySafeMessage": "A professional, clinical-grade summary in THIRD-PERSON perspective. NEVER quote the student directly. Use academic/clinical language suitable for educator review. Examples: 'Student exhibits indicators of significant academic stress and anxiety' or 'Behavioral patterns suggest potential peer victimization concerns' or 'Student references concerning thoughts about self-harm' or 'Student expresses worry about a peer's wellbeing and safety'.",
